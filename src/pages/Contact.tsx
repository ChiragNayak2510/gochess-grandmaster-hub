            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-8">
                  Have questions about our programs, tutoring opportunities, or anything else? We'd love to hear from you! Fill out the form or use our contact information below.
                </p>
